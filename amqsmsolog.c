...
/* MQMBID Start */
  ...
  #define __MQMBID_H
  #if defined(_AIX)
    #pragma comment(user, "@(#) MQMBID sn=p750-004-140807 su=_pY8W4B4HEeS1ypf5zzZGLw pn=samples/c/amqsaxe0.c")
  #elif defined(hpux)
    #pragma VERSIONID "@(#) MQMBID sn=p750-004-140807 su=_pY8W4B4HEeS1ypf5zzZGLw pn=samples/c/amqsaxe0.c"
  #elif defined(_LINUX_2)
    static char * __attribute__((used)) MQMBID(void) { return "@(#) MQMBID sn=p750-004-140807 su=_pY8W4B4HEeS1ypf5zzZGLw pn=samples/c/amqsaxe0.c"; }
  #elif defined(WIN32) || defined(_WIN32)
    #pragma optimize("", off)
    const static char MQMBID[]="@(#) MQMBID sn=p750-004-140807 su=_pY8W4B4HEeS1ypf5zzZGLw pn=samples/c/amqsaxe0.c";
    #pragma optimize("", on)
  #else
    static char * MQMBID(void) { return "@(#) MQMBID sn=p750-004-140807 su=_pY8W4B4HEeS1ypf5zzZGLw pn=samples/c/amqsaxe0.c"; }
  #endif
#endif
/* MQMBID End */
